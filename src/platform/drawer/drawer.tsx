...
const CustomDrawer: React.FC<DrawerContentComponentProps> = (props) => {
  ...
  const btnAnimationStyle = useAnimatedStyle(() => ({
    backgroundColor: btnClick.value ? withTiming('#f9b80b', { duration: 300 }) : withTiming('#fff', { duration: 300 }),
  }));
  ...
  const iconAnimationStyle = useAnimatedStyle(() => ({
    ...
    color: btnClick.value ? withTiming('#fff', { duration: 300 }) : withTiming('gray', { duration: 300 }),
  }));
