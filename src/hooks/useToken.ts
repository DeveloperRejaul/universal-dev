...
export const useToken = (felid: 'colors'|'size'|'fontFamily', value: colorType| sizeType | fontFamalyType, alpha?: alphaPercentage) => {
  ...
  if(felid ==='fontFamily') return config.theme['fontFamily'][value][0];
};
